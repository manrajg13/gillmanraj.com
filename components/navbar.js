...
export default function Navbar() {
	...
	return (
		<nav id='n' className='fixed ml-[-375px] py-4 left-[50%] top-0 text-sm font-bold text-white w-[750px] bg-background/[0.8] z-14 transition -translate-y-12 delay-[3000ms] duration-500'>
