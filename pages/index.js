...
export default function Home() {
	...
	useEffect(() => {
		...
		document.getElementById('model').classList.remove('-translate-y-[300px]')
	})
	...
	return (
		<>
			...
			<div className='w-[720px] mx-auto'>
				<div className='flex relative h-[380px] mx-auto'>
					<Canvas id='model' className='transition -translate-y-[300px] duration-[2000ms]' 
					...
					<div className='absolute mx-auto text-center bottom-0 left-0 right-0'>
						<h1 id='h1' className='text-white font-bold text-xl leading-5 opacity-0 transition duration-[1200ms] -translate-y-2'>Hi there, my name is Manraj Gill.</h1>
						<h1 id='h2' className='font-bold text-red text-sm opacity-0 transition duration-[400ms] delay-[1800ms] -translate-y-2'>SOFTWARE ENGINEER</h1>

						<div id='links' className='flex place-content-center mt-3 font-bold text-white text-xs transition duration-500 delay-[3200ms] opacity-0 translate-y-2'>
				...
				<div id='about' className='mt-14 opacity-0 transition duration-500 delay-[3000ms]'>
					...
					<div className='text-white leading-5'>
						...
						<p className='mt-4'>I enjoy creating traditional and digital art in my freetime and </p>
						<p className='mt-4'>Some technologies I have worked with:</p>
						<div className='grid mt-4 grid-cols-4 font-bold text-sm'>
				...
				<div id='experience' className='mt-10 opacity-0 transition duration-500 delay-[3000ms]'>
					...
					<div className='m-3 mt-8'>
						<div className='group px-2 py-2 font-bold text-sm overflow-hidden hover:cursor-pointer transition hover:opacity-70' onClick={toggle1}>
							...
							<div className='mx-6 mb-1 font-normal text-sm text-white leading-5' style={{display: showMe1?"block":"none"}}>
								<p><FaChevronRight className='inline-flex mb-[2px] text-red text-xs' /> I&apos;ll let you know when I find out </p>
							</div>
						</div>

						<hr className='ml-1 border-white/[0.15]'></hr>
						...
						<div className='group px-2 py-2 font-bold text-sm overflow-hidden hover:cursor-pointer transition hover:opacity-70' onClick={toggle2}>
							...
							<div className='mx-6 mb-1 font-normal text-sm text-white leading-5' style={{display: showMe2?'block':'none'}}>
								<p><FaChevronRight className='inline-flex mb-[2px] text-red text-xs' /> Managed asset data collection of over 200 parks in Windsor</p>
								<p><FaChevronRight className='inline-flex mb-[2px] text-red text-xs' /> Verified and updated over 4000 assets using Citywide Software</p>
								<p><FaChevronRight className='inline-flex mb-[2px] text-red text-xs' /> Regularly performed quality checks on assigned assets in database</p>
							</div>
						</div>
				...
				<div id='projects' className='mt-12 opacity-0 transition duration-500 delay-[3000ms]'>
					<p className='my-1 text-red font-bold'>PROJECTS</p> 
					<hr className='border-white/[0.15]'></hr>

					<div className='grid grid-flow-col place-content-center mt-10 text-white'>
						<a className='group relative p-6 mx-2 border border-white w-[230px] h-[230px] shadow-lg
							...
							<div className='inline-flex absolute bottom-6 text-xs'>
								<p className='p-[2px] px-1 mr-1 bg-blue/[0.2] text-blue group-hover:bg-red/[0.2] group-hover:text-red'>Javascript</p>
								<p className='p-[2px] px-1 mr-1 bg-blue/[0.2] text-blue group-hover:bg-red/[0.2] group-hover:text-red'>ChartJS</p>
							</div>
						</a>
						...
						<a className='group relative p-6 mx-2 border border-white w-[230px] h-[230px] shadow-lg
							...
							<div className='inline-flex absolute bottom-6 text-xs'>
								<p className='p-[2px] px-1 mr-1 bg-blue/[0.2] text-blue group-hover:bg-red/[0.2] group-hover:text-red'>Javascript</p>
								<p className='p-[2px] px-1 mr-1 bg-blue/[0.2] text-blue group-hover:bg-red/[0.2] group-hover:text-red'>NodeJS</p>
								<p className='p-[2px] px-1 mr-1 bg-blue/[0.2] text-blue group-hover:bg-red/[0.2] group-hover:text-red'>ThreeJS</p>
							</div>
						</a>
						...
						<a className='group relative p-6 mx-2 border border-white w-[230px] h-[230px] shadow-lg
							...
							<div className='inline-flex absolute bottom-6 text-xs'>
								<p className='p-[2px] px-1 mr-1 bg-blue/[0.2] text-blue group-hover:bg-red/[0.2] group-hover:text-red'>Rust</p>
								<p className='p-[2px] px-1 mr-1 bg-blue/[0.2] text-blue group-hover:bg-red/[0.2] group-hover:text-red'>ggez</p>
							</div>
						</a>
					</div>
				</div>

				<div id='contact' className='mt-10 opacity-0 transition duration-500 delay-[3000ms]'>
					<p className='my-1 text-red font-bold'>CONTACT</p> 
					<hr className='border-white/[0.15]'></hr>

					<div className='mx-20'>
						<p className='mt-10 text-white text-center leading-4'>I&apos;m always open to conversations for new opportunities! Feel free to email me at the address below or say hi on LinkedIn.</p>
						<div className='flex mt-10 place-content-center'>
							<a className='px-3 py-2 mx-1 bg-red rounded-sm font-bold text-white text-sm hover:opacity-70 hover:cursor-pointer transition' 
									href='mailto:manraj836@gmail.com?body=Hello%20Manraj%2C%0D%0A' >manraj836@gmail.com</a>
						</div>
					</div>
				</div>

				<footer className='relative mt-16 mx-auto bottom-0 p-5 text-center text-white/[0.4] text-xs'> © 2022 Manraj Gill. All Rights Reserved. </footer>
			</div>
		</>
	)
}
